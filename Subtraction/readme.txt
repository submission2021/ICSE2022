This directory contains the subtraction subject.

In the CRN/ directory, the full set of text implementations of the golden model (S0, S100) and mutants.
Subjects 100-110 are from Gerten et. al
